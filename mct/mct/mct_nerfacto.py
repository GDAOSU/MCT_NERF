...
@dataclass
class MCTNerfactoModelConfig(ModelConfig):
    """Nerfacto Model Config"""

    _target: Type = field(default_factory=lambda: MCTNerfactoModel)
    """ use our own collider, just to avoid initialize NearFarcollider"""
    enable_collider: bool = False
    near_plane: float = 0.00
