...
from mct.mct_neus import MCTNeuSModelConfig,MCTNeuSModel
...
@dataclass
class MCTNeuSFactoModelConfig(MCTNeuSModelConfig):
    """NeusFacto Model Config"""

    _target: Type = field(default_factory=lambda: MCTNeuSFactoModel)
...
class MCTNeuSFactoModel(MCTNeuSModel):
    ...
    config: MCTNeuSFactoModelConfig
