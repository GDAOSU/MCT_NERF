...
@dataclass
class MCTNeuSModelConfig(SurfaceModelConfig):
    """NeuS Model Config"""

    _target: Type = field(default_factory=lambda: MCTNeuSModel)
    near_plane: float = 0.00
    """How far along the ray to start sampling."""
    far_plane: float = 1000.0
    """How far along the ray to stop sampling."""
    far_plane_bg: float = 10000.0
    ...
    num_samples_outside: int=0
    


class MCTNeuSModel(SurfaceModel):
    """NeuS model
