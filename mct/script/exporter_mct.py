...
@dataclass
class ExportPointCloudAll(Exporter):
    """Export NeRF as a point cloud."""
    ...
    def main(self) -> None:
        ...
        _, pipeline, _, _ = eval_setup(self.load_config,self.num_rays_per_batch,test_mode='all')
...
Commands = tyro.conf.FlagConversionOff[
    Union[
        ...
        Annotated[ExportPointCloudAll, tyro.conf.subcommand(name="pointcloudall")],
